...
public class InterviewQuestionService {
        ...
        // public FollowUpQuestionsResponseDto generateFollowUpQuestions(Long
        // interviewId) {
        ...
        // if (!isGeminiUsable()) {
        // log.warn("[InterviewQuestionService] Gemini disabled or API key missing.
        // Returning local mock follow-up questions.");
        ...
        // log.warn("[InterviewQuestionService] Gemini returned less than 5 questions.
        ...
        // log.error("[InterviewQuestionService] Gemini API call failed: {}",
        // ex.getMessage());
        ...
        // return new FollowUpQuestionsResponseDto(interviewId, applicationId,
        // questions);
        // }
        ...
        // if (application.getMatchedSkills() != null &&
        // !application.getMatchedSkills().isEmpty()) {
        ...
        // !application.getMissingSkills().isEmpty()) {
        // sb.append("Missing/Weak Skills from screening: ")
        // .append(String.join(", ", application.getMissingSkills()))
        // .append("\n");
        // }

        // if (application.getAiRationale() != null &&
        // !application.getAiRationale().isBlank()) {
        // sb.append("AI Screening Rationale: ")
        // .append(application.getAiRationale())
        // .append("\n");
        // }

        // if (application.getOtherSkills() != null &&
        // !application.getOtherSkills().isEmpty()) {
        ...
        // "- Technical=%d, Communication=%d, ProblemSolving=%d, CultureFit=%d,
        // Avg=%.1f, Recommendation=%s\n",
        ...
        // sb.append(String.format(
        // "\nAggregate scores: Technical=%.1f, Communication=%.1f, ProblemSolving=%.1f,
        // CultureFit=%.1f\n",
        // avgTechnical,
        // avgCommunication,
        // avgProblemSolving,
        ...
        // Each question must:
        // 1. Be specific and directly tied to resume skills, missing skills, or
        // scorecard competency gaps.
        ...
        // Example:
        // [
        // { "question": "Can you explain how you used Spring Boot in your previous
        // project?", "intent": "Resume Deep-Dive – Skills" },
        // { "question": "Describe a time when you solved a production issue under
        // pressure.", "intent": "Behavioural – Situational" }
        // ]
        // """);
        ...
        // private List<FollowUpQuestionDto> parseGeminiResponse(String
        // geminiResponseBody) {
        // try {
        ...
        // throw new IllegalStateException("Gemini response does not contain
        // candidates");
        // }
        ...
        // } catch (Exception ex) {
        // log.error("[InterviewQuestionService] Failed to parse Gemini response: {}",
        // ex.getMessage());
        // throw new BusinessException(
        // HttpStatus.INTERNAL_SERVER_ERROR,
        ...
        // throw new IllegalArgumentException("No valid JSON array found in Gemini
        // response");
        // }
        ...
        // [
        // {
        // "question": "Can you explain one project where you used Java and Spring Boot
        // to build a backend API?",
        // "intent": "Resume Deep-Dive – Skills"
        // },
        // {
        // "question": "How did you handle database operations and query optimization in
        // your previous work?",
        // "intent": "Resume Deep-Dive – Experience"
        // },
        // {
        // "question": "Can you describe a difficult technical problem you solved and
        // how you approached it?",
        // "intent": "Gap Probe – Problem Solving"
        // },
        // {
        // "question": "How do you explain technical issues to a non-technical team
        // member or stakeholder?",
        // "intent": "Gap Probe – Communication"
        // },
        // {
        // "question": "Tell me about a time when you received feedback and improved
        // your work based on it.",
        // "intent": "Behavioural – Situational"
        // },
        // {
        // "question": "How do you make sure your code is maintainable, testable, and
