...
public class ApplicationMapper {
    ...
    public static Application dtoToApplicationEntity(ApplicationDto dto) {
        ...
        application.setMatchedSkills(
                dto.getMatchedSkills() == null ? new ArrayList<>() : dto.getMatchedSkills()
        );

        application.setMissingSkills(
                dto.getMissingSkills() == null ? new ArrayList<>() : dto.getMissingSkills()
        );

        application.setOtherSkills(
                dto.getOtherSkills() == null ? new ArrayList<>() : dto.getOtherSkills()
        );

        application.setAiScore(dto.getAiScore());
        application.setAiRationale(dto.getAiRationale());
        application.setCurrentStage(dto.getCurrentStage());
        application.setStageMoveReason(dto.getStageMoveReason());
        application.setFreeNotes(dto.getFreeNotes());
        application.setReferralCode(dto.getReferralCode());
        application.setBlockedFromReapply(dto.getBlockedFromReapply());
        application.setRejectionReason(dto.getRejectionReason());

        return application;
    }

    public static ApplicationDto applicationEntityToDto(Application application) {
        ...
        dto.setOtherSkills(application.getOtherSkills());
        dto.setAiScore(application.getAiScore());
        dto.setAiRationale(application.getAiRationale());
        dto.setCurrentStage(application.getCurrentStage());
        dto.setStageMoveReason(application.getStageMoveReason());
        dto.setFreeNotes(application.getFreeNotes());
        dto.setReferralCode(application.getReferralCode());
        dto.setBlockedFromReapply(application.getBlockedFromReapply());
        dto.setAppliedAt(application.getAppliedAt());
        dto.setScreeningAt(application.getScreeningAt());
        dto.setTechnicalAt(application.getTechnicalAt());
        dto.setInterviewAt(application.getInterviewAt());
        dto.setFinalRoundAt(application.getFinalRoundAt());
        dto.setOfferAt(application.getOfferAt());
