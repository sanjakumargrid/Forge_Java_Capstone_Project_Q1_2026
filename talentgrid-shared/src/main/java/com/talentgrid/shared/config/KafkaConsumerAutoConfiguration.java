...
public class KafkaConsumerAutoConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, AuthUserUpdatedEvent> authUserConsumerFactory() {

        JsonDeserializer<AuthUserUpdatedEvent> deserializer =
                new JsonDeserializer<>(AuthUserUpdatedEvent.class);

        deserializer.addTrustedPackages("com.talentgrid.shared.kafka");
